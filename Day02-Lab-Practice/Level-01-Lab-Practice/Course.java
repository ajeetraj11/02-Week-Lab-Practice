// Course class that represents an online course with individual details and a shared institute name
public class Course {

    // Declaring private instance variable for course name
    private String courseName;

    // Declaring private instance variable for course duration in weeks
    private int duration;

    // Declaring private instance variable for course fee
    private double fee;
