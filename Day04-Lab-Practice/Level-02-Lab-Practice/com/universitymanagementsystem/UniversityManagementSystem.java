...
class UniversityManagementSystem {
    public static void main(String[] args) {
        ...
        Student1 student2 = new Student1("Yuvraj");
        Student1 student3 = new Student1("Ankit");

        // Creating Professor objects
        Professor professor1 = new Professor("Dr. Ajeet");
        Professor professor2 = new Professor("Dr. Abhishek");
